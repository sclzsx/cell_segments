...
DSB2018_PATH = 'datasets/dsb2018_kaggle_split'
LOG_DIRECTORY = 'results/dsb2018_kaggle_split'
N_RAYS = 32
...
SAVE_PATH = './'+dataset+'/'+train_mode+'_'+model_name+'/'
kwargs['save_path'] = SAVE_PATH
RESULTS_DIRECTORY = './'+dataset+'/'+train_mode+'_'+model_name+'/plots/'
loss = MyL1BCELoss()
trainer = Trainer(loss, None, LOG_DIRECTORY, validate_every= 2)

if LOAD_CHECKPOINT:
    weights_path =SAVE_PATH+model_name+'_'+train_mode+'_'+dataset+'.t7'
    path_checkpoint = './CHECKPOINT/checkpoint_'+model_name+'_'+train_mode+'_'+dataset+'/CHECKPOINT.t7'
